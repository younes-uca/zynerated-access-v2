...
import ma.zs.easystock.zynerator.security.dao.specification.core.UserSpecification;
...
import ma.zs.easystock.zynerator.security.service.facade.*;
...
//            Role roleForAdmin = roleService.findByAuthority(AuthoritiesConstants.ADMIN);
//            if(t.getRoleUsers()==null)
//                t.setRoleUsers(new ArrayList<>());
//
//            t.getRoleUsers().add(roleForAdmin);
//
//            if (t.getRoleUsers() != null) {
...
//            }
    ...
    @Autowired
    private ModelPermissionAdminService modelPermissionAdminService ;
    @Autowired
    private ActionPermissionAdminService actionPermissionAdminService ;
    @Autowired
